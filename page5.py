...
renew_button.bind("<Button-1>", lambda e: callback("https://github.com/KD-2004/python-projects"))

#made by
last_img = ImageTk.PhotoImage(Image.open("1x/boxTiny.png"))
Label(image=last_img,bg=backgroundColor).place(relx = 0.72, rely =0.8)
Label(text=" \"Cyber Sense\"\nKaushalDholakiya", font=("Lucida Sans",8),fg=active_color,background=backgroundColor, justify=LEFT).place(relx=0.73,rely=0.82)
